...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $qualificationService->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $qualificationService->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="qualificationService form content">
            ...
            <fieldset>
                <legend><?= __('Edit Qualification Service') ?></legend>
                <?php
